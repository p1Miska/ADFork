 ...
 * and BEFORE movement/jump input is sampled (KeyboardInput.tick).
 *
...
public class AdGifClient implements ClientModInitializer {
    ...
    private void onClientTick(MinecraftClient client) {
        ...
        if (active) {
            ...
            // Refresh health snapshot while frozen so damage taken during the
            // ad cannot fire the damage trigger right after it ends.
