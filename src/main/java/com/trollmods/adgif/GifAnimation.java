 ...
 * once, the LAST frame is held until the ad timer expires. (Looping caused a
 * "ghost replay" flash when the gif length was slightly shorter than the ad
 * duration - the animation silently wrapped back to frame 0 for a moment.)
 */
public class GifAnimation {
     ...
     * then holds the last frame forever (no looping).
     */
